class Hotel {
    ...
    checkOut(currentBookingNumber) {
        ...
        let bookingIndex = this.bookings.findIndex(function (currentBooking) {
            return currentBooking.roomNumber === booking.roomNumber;
            // When finds the booking (it will be true), will return booking index.
        });
