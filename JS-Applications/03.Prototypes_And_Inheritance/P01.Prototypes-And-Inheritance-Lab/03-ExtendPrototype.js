...
let person = new Person('Jake', 'jake@gmail.com');
console.log(person.toSpeciesString());

let teacher = new Teacher('Logan', 'logan@gmail.com', 'Coding');
console.log(teacher.toSpeciesString());

let student = new Student('Shane', 'shane@gmail.com', 'JavaScript Applications');
